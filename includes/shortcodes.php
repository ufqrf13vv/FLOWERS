            ...
            <div class="contacts__item">
                ...
                <div class="contacts__item-wrap">
                    ...
                    <div class="contacts__description">
                        ...
                        <button class="contacts__hide">Скрыть<span class="fa fa-angle-double-up contacts__arrow"></span>
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div class="feedbacks__slider">
                ...
                foreach ($posts as $post) {
                    ...
                    <div class="feedbacks__item">
                        ...
                        <div class="feedbacks__text"><?php echo short_text($post->post_content); ?>
                            <span class="feedbacks__date"><?php echo date_cut_time($post->post_date); ?></span>
                            <a class="feedbacks__readmore" href="javascript: void(0);"
                               data-postID="<?php echo $post->ID; ?>">Читать далее</a>
                        </div>
                    </div>
                    <?php
                }
